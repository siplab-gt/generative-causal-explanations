...
%Data fidelity vs L:
load('results/z_dim_paramSelect_MNIST_class38.mat');
subplot(1,3,1);
...
load('results/alphaFinal_paramSelect_MNIST_class38.mat');
subplot(1,3,2);
...
load('results/alpha1_paramSelect_MNIST_class38.mat');
subplot(1,3,3);
...
if export_plots
  fprintf('Exporting...');
  export_fig('./figs/fig_tuning_mnist.pdf')
  saveas(gcf,'./figs/fig_tuning_mnist.svg');
  fprintf('done!\n');
end
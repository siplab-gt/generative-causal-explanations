"""
    ...
    Reproduces Figure 13 in O'Shaughnessy et al., 'Generative causal
    explanations of black-box classifiers,' Proc. NeurIPS 2020: global
    explanation for CNN classifier trained on MNIST 1/4/9 digits.
"""
...
plotting.plotExplanation(1.-Xhats, yhats, save_path='figs/fig13')
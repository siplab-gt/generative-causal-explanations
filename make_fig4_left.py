"""
    ...
    Reproduces left pane of Figure 4 in O'Shaughnessy et al., 'Generative
    causal explanations of black-box classifiers,' Proc. NeurIPS 2020: sample
    explanations from other methods for MNIST 3/8 digits.
"""
...
classifier_save_dir = './pretrained_models/mnist_38_classifier/model.pt'
# parameters to use for other methods
parameters = {
    'lime' : {'K' : 5},
    'shap' : {},
    'ig'   : {'steps' : 50},
...
# from author's code - https://github.com/Jianbo-Lab/L2X
...
plt.axis('off')
plt.savefig('./figs/fig4_mnist_3.svg', bbox_inches=0)
...
plt.axis('off')
plt.savefig('./figs/fig4_mnist_8.svg', bbox_inches=0)
...
plt.axis('off')
plt.savefig('./figs/fig4_lime_3.svg', bbox_inches=0)
...
plt.axis('off')
plt.savefig('./figs/fig4_lime_8.svg', bbox_inches=0)
...
plotting.outline_mask(ax, x3 > 0, bounds=(0,27,0,27))
plt.axis('off')
plt.savefig('./figs/fig4_shap_3.svg', bbox_inches=0)
...
plotting.outline_mask(ax, x8 > 0, bounds=(0,27,0,27))
plt.axis('off')
plt.savefig('./figs/fig4_shap_8.svg', bbox_inches=0)
...
plotting.outline_mask(ax, x3 > 0, bounds=(0,27,0,27))
plt.axis('off')
plt.savefig('./figs/fig4_ig_3.svg', bbox_inches=0)
...
plotting.outline_mask(ax, x8 > 0, bounds=(0,27,0,27))
plt.axis('off')
plt.savefig('./figs/fig4_ig_8.svg', bbox_inches=0, dpi=160)
...
plotting.outline_mask(ax, x3 > 0, bounds=(0,27,0,27))
plt.axis('off')
plt.savefig('./figs/fig4_l2x_3.svg', bbox_inches=0)

...
load('results/visualize_causalobj_linear.mat');
figure(1); clf;
fsize = 28;
...
if export_plots
  ...
  export_fig('./figs/fig_lingauss_objective_linear.pdf')
  saveas(gcf,'./figs/fig_lingauss_objective_linear.svg');
  fprintf('done!\n');
end


%% Figure 9 - and classifier, individual components of objective
load('results/visualize_causalobj_and.mat');
figure(2); clf;
fsize = 28;
allnce = [data.ce_iu(:);
  data.ce_ic(:);
...
if export_plots
  ...
  export_fig('./figs/fig_lingauss_objective_and.pdf');
  saveas(gcf,'./figs/fig_lingauss_objective_and.svg');
  fprintf('done!\n');
end
...
if export_plots
  ...
  export_fig ./figs/fig_lingauss_fullobjective_and.pdf
  saveas(gcf,'./figs/fig_lingauss_fullobjective_and.svg');
  fprintf('done!\n');
end

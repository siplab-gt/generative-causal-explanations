...
class Encoder(nn.Module):
    ...
    def __init__(self, z_dim, c_dim, x_dim): # x_dim : total number of pixels
        ...
        self.fc_mu = nn.Linear(int(64*x_dim/16), z_dim)
        self.fc_logvar = nn.Linear(int(64*x_dim/16), z_dim)
...
class Decoder(nn.Module):
    ...
    def __init__(self, z_dim, c_dim, x_dim): # x_dim : total number of pixels
        ...
        self.fc = nn.Sequential(
            nn.Linear(z_dim, int(64*self.x_dim/16)),
            nn.ReLU()
        )
        self.model = nn.Sequential(
    ...
    def forward(self, z):
        ...
        t = self.fc(z).view(batch_size, 64,

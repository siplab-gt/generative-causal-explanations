"""
    ...
    Reproduces Figure 14 in O'Shaughnessy et al., 'Generative causal
    explanations of black-box classifiers,' Proc. NeurIPS 2020: global
    explanation for CNN classifier trained on MNIST 1/4/9 digits (finer zoom)
"""
import numpy as np
...
data_classes = [1, 4, 9]
# classifier
classifier_path = './pretrained_models/mnist_149_classifier'
# vae
K = 2
L = 2
train_steps = 8000
...
# other
randseed = 0
gce_path = './pretrained_models/mnist_149_gce'
...
zs_sweep = np.linspace(-2.0, 2.0, 41)
Xhats, yhats = gce.explain(x, zs_sweep)
plotting.plotExplanation(1.-Xhats, yhats, save_path='figs/fig14')